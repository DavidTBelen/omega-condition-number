...
if strcmp(type, 'time')
    ...
    measure(:,5) = output.ichol_2_prec.time;
...
elseif strcmp(type, 'iterations')
    ...
    measure(:,5) = output.ichol_2_prec.it;
...
elseif strcmp(type, 'residuals')
    ...
    measure(:,5) = output.ichol_2_prec.res;
...
elseif strcmp(type, 'time_prec')
    ...
    measure(:,5) = output.ichol_2_prec.time_prec;
...
if strcmp(type, 'time_prec')
    ...
    fprintf(fid,'%s\n', '\begin{tabular}{|l|rr|r|r|r|r|r|} \hline');
