...
namefile = '../../condnumbandQPlatexfiles.d/tableomegatimes.tex';
...
for jj = 1:length(n)
    ...
    for kk =1:length(xkappa)
        fprintf(fid, '& %1.4e', meanresulttimes(jj,kk,1));
    end
    ...
    for kk =1:length(xkappa)
        fprintf(fid, '& %1.4e', meanresulttimes(jj,kk,2));
    end
    ...
    for kk =1:length(xkappa)
        fprintf(fid, '& %1.4e', meanresulttimes(jj,kk,3));
